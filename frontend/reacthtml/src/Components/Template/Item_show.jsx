                    ...
                    <div className="row">
                        <div className="col-md-6 col-sm-6">
                            ...
                            <div className="product-main-image">
                                <img src="assets/pages/img/products/model7.jpg" alt="Cool green dress with red bell" className="img-responsive" data-BigImgsrc="assets/pages/img/products/model7.jpg"/>
                            </div>
                            </div>

                            <div className="product-other-images">
                                <a href="assets/pages/img/products/model3.jpg" className="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="assets/pages/img/products/model3.jpg"/></a>
                                <a href="assets/pages/img/products/model4.jpg" className="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="assets/pages/img/products/model4.jpg"/></a>
                                <a href="assets/pages/img/products/model5.jpg" className="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="assets/pages/img/products/model5.jpg"/></a>
                            </div>
                        </div>
                        <div className="col-md-6 col-sm-6">
                            ...
                            <div className="product-page-cart">
                                <div className="product-quantity">
                                    <input id="product-quantity" type="text" value="1" readonly className="form-control input-sm"/>
                                </div>
                            ...
                            <div id="myTabContent" className="tab-content">
                                ...
                                <div className="tab-pane fade in active" id="Reviews">
                                    ...
                                    <form action="#" className="reviews-form" role="form">
                                        ...
                                        <div className="form-group">
                                            <label for="review">Review <span className="require">*</span></label>
