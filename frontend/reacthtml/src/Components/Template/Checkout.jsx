                    ...
                    <div className="panel-group checkout-page accordion scrollable" id="checkout-page">
                        ...
                        <div id="checkout" className="panel panel-default">
                            <div className="panel-heading">
                                <h2 className="panel-title">
                                    <a data-toggle="collapse" data-parent="#checkout-page" href="#checkout-content" className="accordion-toggle">Step 1: Checkout Options</a></h2>
                            </div>
                            <div id="checkout-content" className="panel-collapse collapse in">
                                <div className="panel-body row">
                                    <div className="col-md-6 col-sm-6">
                                        ...
                                        <button className="btn btn-primary" type="submit" data-toggle="collapse"
                                                data-parent="#checkout-page"
                                                data-target="#payment-address-content">Continue
                                        </button>
                                    </div>
                                    <div className="col-md-6 col-sm-6">
                                            ...
                                            <div className="login-socio">
                                                ...
                                                <ul className="social-icons">
                                                    <li><a href="javascript:;" data-original-title="facebook"
                                                           className="facebook" title="facebook"></a></li>
                                                    <li><a href="javascript:;" data-original-title="Twitter"
                                                           className="twitter" title="Twitter"></a></li>
                                                    <li><a href="javascript:;" data-original-title="Google Plus"
                                                           className="googleplus" title="Google Plus"></a></li>
                                                    <li><a href="javascript:;" data-original-title="Linkedin"
                                                           className="linkedin" title="LinkedIn"></a></li>
                                                </ul>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div className="panel-heading">
                                <h2 className="panel-title">
                                    <a data-toggle="collapse" data-parent="#checkout-page"
                                       href="#payment-address-content" className="accordion-toggle">
                            ...
                            <div id="payment-address-content" className="panel-collapse collapse">
                                <div className="panel-body row">
                                    <div className="col-md-6 col-sm-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="telephone">Telephone <span
                                                className="require">*</span></label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="password-confirm">Password Confirm <span
                                                className="require">*</span></label>
                                    ...
                                    <div className="col-md-6 col-sm-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="post-code">Post Code <span
                                                className="require">*</span></label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="region-state">Region/State <span
                                                className="require">*</span></label>
                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <button className="btn btn-primary  pull-right" type="submit"
                                                ...
                                                id="button-payment-address">Continue
                                        </button>
                        ...
                        <div id="shipping-address" className="panel panel-default">
                            <div className="panel-heading">
                                <h2 className="panel-title">
                                    <a data-toggle="collapse" data-parent="#checkout-page"
                                       href="#shipping-address-content" className="accordion-toggle">
                            ...
                            <div id="shipping-address-content" className="panel-collapse collapse">
                                <div className="panel-body row">
                                    <div className="col-md-6 col-sm-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="lastname-dd">Last Name <span
                                                className="require">*</span></label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="telephone-dd">Telephone <span
                                                className="require">*</span></label>
                                    ...
                                    <div className="col-md-6 col-sm-6">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="post-code-dd">Post Code <span
                                                className="require">*</span></label>
                                            <input type="text" id="post-code-dd" className="form-control"/>
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="country-dd">Country <span
                                                className="require">*</span></label>
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="region-state-dd">Region/State <span
                                                className="require">*</span></label>
                        ...
                        <div id="shipping-method" className="panel panel-default">
                            <div className="panel-heading">
                                <h2 className="panel-title">
                                    <a data-toggle="collapse" data-parent="#checkout-page"
                                       href="#shipping-method-content" className="accordion-toggle">
                            ...
                            <div id="shipping-method-content" className="panel-collapse collapse">
                                <div className="panel-body row">
                                    <div className="col-md-12">
                                        ...
                                        <div className="radio-list">
                                            <label>
                                                <input type="radio" name="FlatShippingRate"
                                        ...
                                        <button className="btn btn-primary  pull-right" type="submit"
                                                ...
                                                data-parent="#checkout-page"
                                                data-target="#payment-method-content">Continue
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="payment-method" className="panel panel-default">
                            <div className="panel-heading">
                                <h2 className="panel-title">
                                    <a data-toggle="collapse" data-parent="#checkout-page"
                                       href="#payment-method-content" className="accordion-toggle">
                            ...
                            <div id="payment-method-content" className="panel-collapse collapse">
                                <div className="panel-body row">
                                    <div className="col-md-12">
                                        ...
                                        <div className="radio-list">
                                            <label>
                                                <input type="radio" name="CashOnDelivery" value="CashOnDelivery"/> Cash
                                                On Delivery
                                            </label>
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="delivery-payment-method">Add Comments About Your
                                                Order</label>
                                        ...
                                        <button className="btn btn-primary  pull-right" type="submit"
                                                ...
                                                data-parent="#checkout-page" data-target="#confirm-content">Continue
                                        </button>
                                        <div className="checkbox pull-right">
                                            <label>
                            ...
                            <div id="confirm-content" className="panel-collapse collapse">
                                <div className="panel-body row">
                                    <div className="col-md-12 clearfix">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="checkout-description">
                                                        <h3><a href="javascript:;">Cool green dress with red bell</a>
                                                        </h3>
                                                    ...
                                                    <td className="checkout-price"><strong><span>$</span>47.00</strong>
                                                    </td>
                                                    <td className="checkout-total"><strong><span>$</span>47.00</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td className="checkout-image">
                                        ...
                                        <button className="btn btn-primary pull-right" type="submit"
                                                id="button-confirm">Confirm Order
                                        </button>
                                        <button type="button"
                                                className="btn btn-default pull-right margin-right-20">Cancel
                                        </button>
                                    </div>
                                </div>
                            </div>
